                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input name="product_image_name" id="product_image_name" type="text" class="form-control" placeholder="Name">
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input name="product_ordering" id="product_ordering" type="text" class="form-control" placeholder="number">
                                        </div>
