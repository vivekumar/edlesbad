...
<body>
    ...
    <div class="accountbg" style="background-color:black"></div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="text-center mt-4">
                                <div class="mb-3">
                                    <a href="javascript: void(0)"><img src="{{asset('/images/logo/logo-4.png')}}" alt="logo"></a>
                                </div>
                            </div>
                            <div class="p-3">
                                <h4 class="font-size-18 mt-2 text-center">Welcome Back !</h4>
                                <p class="text-muted text-center mb-4">Sign in to continue to EdlesBad.</p>

                                @if(session ('sadminloginerror'))
                                <div class="alert alert-info">
                                    {{ session ('sadminloginerror') }}
                                </div>
                                @endif
